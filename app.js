...
const livePreview=document.createElement('section');livePreview.className='market-preview embedded-preview';livePreview.innerHTML=`<div class="market-preview-copy"><strong>Live market preview</strong><p>TradingView’s NIFTY view opens here when available. Stride charts and alerts still use demo data.</p><a href="https://www.tradingview.com/symbols/NSE-NIFTY/" target="_blank" rel="noopener noreferrer">Open full NIFTY view ↗</a></div><div class="tv-widget"><div class="tradingview-widget-container"><div class="tradingview-widget-container__widget"></div><div class="tradingview-widget-copyright"><a href="https://www.tradingview.com/symbols/NSE-NIFTY/" target="_blank" rel="noopener noreferrer"><span class="blue-text">NIFTY chart</span> by TradingView</a></div></div></div>`;document.querySelector('main')?.prepend(livePreview);const tvScript=document.createElement('script');tvScript.src='https://s3.tradingview.com/external-embedding/embed-widget-symbol-overview.js';tvScript.async=true;tvScript.textContent=JSON.stringify({symbols:[['NSE:NIFTY|1D']],chartOnly:false,width:'100%',height:180,locale:'en',colorTheme:'dark',autosize:false,showVolume:true,showMA:false,hideDateRanges:false,hideMarketStatus:false,hideSymbolLogo:false,scalePosition:'right',scaleMode:'Normal',fontFamily:'Inter, system-ui, sans-serif',fontSize:'10',noTimeScale:false,valuesTracking:'1',changeMode:'price-and-percent',chartType:'area',backgroundColor:'#12191c',lineWidth:2,lineType:0,dateRanges:['1d','1m','3m','6m','1y','5y','all']});livePreview.querySelector('.tradingview-widget-container').append(tvScript);
const liveStyle=document.createElement('style');liveStyle.textContent='.embedded-preview{display:flex;gap:20px;justify-content:space-between;align-items:center;border:1px solid var(--line);border-radius:8px;padding:14px 18px;margin-bottom:20px;background:var(--panel)}.embedded-preview .market-preview-copy{min-width:210px}.embedded-preview p{font-size:12px;color:var(--muted);max-width:80ch;margin:4px 0}.embedded-preview a{display:inline-block;margin-top:8px;padding:9px 12px;border:1px solid var(--line);border-radius:6px;color:var(--green);white-space:nowrap;font-size:13px}.embedded-preview .tv-widget{width:min(620px,56%);border:1px solid var(--line);border-radius:6px;overflow:hidden;background:#12191c}.embedded-preview .tradingview-widget-container{width:100%;padding:6px 8px 0}.embedded-preview .tradingview-widget-copyright{font-size:9px;padding:4px 6px 6px}.embedded-preview .tradingview-widget-copyright a{color:#84969b}.embedded-preview .blue-text{color:#4b9bea}@media(max-width:760px){.embedded-preview{flex-direction:column;align-items:stretch;gap:10px}.embedded-preview a{text-align:center;width:100%}.embedded-preview p{font-size:13px}.embedded-preview .tv-widget{width:100%}}';document.head.append(liveStyle);
